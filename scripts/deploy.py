...
def deploy_token_farm_and_golden_token(front_end_update=False):
    account = get_account()
    ...
    tx.wait(1)
    # golden_token, weth_token, fau_token/dai
...
def main():
    deploy_token_farm_and_golden_token(front_end_update=True)
